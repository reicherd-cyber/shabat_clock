...
const settingsSeed = [
  ...
  ['ivr.relay_menu_item', 'ל{name} הַקֵּשׁ {digit}', 'Dynamic relay-menu fragment'],
  ...
  ['ivr.sched_confirm', 'להדלקת {relay} ביום {on_day} בשעה {on_time} וכיבוי ביום {off_day} בשעה {off_time}, הַקֵּשׁ 1 לאישור, 2 לביטול', 'Schedule read-back'],

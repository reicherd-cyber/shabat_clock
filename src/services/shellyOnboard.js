...
<div class="box">
 <b>איך מתקינים — דרך הרשת שהמכשיר משדר:</b>
 <ol style="margin:6px 0 0;padding-inline-start:18px">
  <li>בטלפון על Wi-Fi רגיל (עם אינטרנט): הקלידו את הקוד ולחצו "התחל התקנה" עד
   שיופיע "פרטי חיבור נוצרו" (המכשיר עוד לא יימצא — זה בסדר).</li>
  <li>עברו ברשתות ה-Wi-Fi של הטלפון לרשת שהמכשיר משדר (...-Shelly), מלאו את
   פרטי ה-Wi-Fi הביתי בקישור "חיבור מכאן" ולחצו שוב — ההגדרות יישלחו והמכשיר
   יתחבר לרשת הביתית לבד.</li>
  <li>חזרו ל-Wi-Fi הרגיל ולחצו "בדוק מול השרת".</li>
 </ol>
